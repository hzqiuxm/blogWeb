...
public class _JFinalGenerator {
    ...
    public static void main(String[] args) {
        ...
        //base model 所使用的包名
        String baseModelPackageName = "com.blogweb.model.base";
        // base model 文件保存路径
//        System.out.println(PathKit.getWebRootPath());
        String baseModelOutputDir = PathKit.getWebRootPath() + "/../moudle/src/main/java/com/blogweb/model/base";
        System.out.println(baseModelOutputDir);
        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.blogweb.model";
